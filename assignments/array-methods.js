...
const donationCalculator = runners.reduce((total, ticketPriceTotal) => {

   for(let i = 0; i < runners.length; i++)
   {
    /*console.log(runners[i].donation); */
    return total += parseInt(runners[i].donation, 10); 
    
   }

});
console.log(donationCalculator);
